  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col grow">
        <h3 className="font-bold text-xl font-heading text-(--text) group-hover:text-(--accent-primary) transition-colors">{p.title}</h3>
        <p className="text-sm text-muted mt-2 leading-relaxed grow">{p.desc}</p>
