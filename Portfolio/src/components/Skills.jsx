...
const skillGroups = [
...

  {
    ...
    skills: [
      ...
      { name: "Redis", icon: <SiRedis />, color: "#DC382D" },
      { name: "Database Design", icon: <FaDatabase />, color: "#AEE2FF" },
    ],
  },
...

  {
    ...
    description: "Operational visibility, metrics, dashboards, and incident readiness.",
    skills: [
      { name: "Prometheus", icon: <SiPrometheus />, color: "#E6522C" },
      { name: "Grafana", icon: <SiGrafana />, color: "#F46800" },
      { name: "Nginx", icon: <SiNginx />, color: "#009639" },
      { name: "Logs & Metrics", icon: <FaServer />, color: "#00ADB5" },
    ],
  },
